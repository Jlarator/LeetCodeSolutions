  ...
  for (int i = 0; i < rowCount; i++) {
    ...
    while ((charCount <= maxWidth) && (wordsIndex < wordsSize)) {
      ...
      if (wordsIndex < wordsSize)
        charCount += strlen(words[wordsIndex]) + 1;
    }

    printf("\nDone with: |%s| -> %d\n", output[i], temp);

    if ((i + 1) < rowCount)
      checkSpaces(output[i], maxWidth);
  }
...
int main(int argc, char *argv[]) {
  ...
  if (argc == 2) {
    ...
    case 1:
      maxWidth = 16;
      arrLen = 6;
      char *arr1[] = {"What",  "must", "be", "acknowledgement",
                      "shall", "be"}; // 16
    ...
    case 2:
      maxWidth = 17;
      arrLen = 15;
      char *arr2[] = {"The",       "important", "thing",    "is",
                      "not",       "to",        "stop",     "questioning.",
                      "Curiosity", "has",       "its",      "own",
                      "reason",    "for",       "existing."}; // 17
    ...
    case 3:
      maxWidth = 20;
      arrLen = 18;
      char *arr3[] = {"Science", "is",        "what", "we",      "understand",
    ...
    case 4:
      maxWidth = 15;
      arrLen = 7;
      char *arr4[] = {"This",          "is", "an", "example", "of", "text",
                      "justification."}; // 15 -> 7
